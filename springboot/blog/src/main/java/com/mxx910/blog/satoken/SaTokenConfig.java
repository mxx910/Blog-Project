package com.mxx910.blog.satoken;
...
import com.mxx910.blog.interceptor.AccessLimitInterceptor;
import com.mxx910.blog.interceptor.PageableInterceptor;
...
//                    SaManager.getLog().debug("----- 请求path={}  提交token={}", SaHolder.getRequest().getRequestPath(), StpUtil.getTokenValue());
                ...
                .setError(e -> {
                    ...
                    if (e instanceof NotLoginException) {
                        return JSONUtil.toJsonStr(Result.fail(StatusCodeEnum.UNAUTHORIZED.getCode(), StatusCodeEnum.UNAUTHORIZED.getMsg()));
                    }
