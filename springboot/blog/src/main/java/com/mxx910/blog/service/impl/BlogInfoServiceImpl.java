...
import static com.mxx910.blog.constant.RedisConstant.ARTICLE_VIEW_COUNT;
import static com.mxx910.blog.constant.RedisConstant.BLOG_VIEW_COUNT;
...
public class BlogInfoServiceImpl implements BlogInfoService {
    ...
    public BlogInfoVO getBlogInfo() {
        Long articleCount = articleMapper.selectCount(new LambdaQueryWrapper<Article>()
                .eq(Article::getStatus, ArticleStatusEnum.PUBLIC.getStatus()).eq(Article::getIsDelete, FALSE));
